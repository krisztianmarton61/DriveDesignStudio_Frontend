...
import { ShapeFromImage } from "./ShapeFromImage";
...
export const ImageEditor: React.FC<EditorProps> = ({
  image,
  onSave,
  onClose,
}) => {
  ...
  }, [workLayer, selectedShape, topLayer]);
      ...
      <div className={style["editor-container"]}>
        <div className={style["shape-select-container"]}>
          <div className={style["shape-select"]}>
            <div className={style["shape-hover"]}>
              <ShapeFromImage
                image={image.value}
                shape={Shape.Circle}
                width={50}
          ...
          <div className={style["shape-select"]}>
            <div className={style["shape-hover"]}>
              <ShapeFromImage
                ...
                height={50}
                id="select3"
                onClick={() => handleSelectedShapeChange(Shape.Heart)}
              />
            </div>
          </div>
          <div className={style["shape-select"]}>
        ...
        <div className={style["text-settings"]}>
          ...
          <button
            ...
            onClick={() => setSelectedShape(Shape.Free)}
          >
            Draw Stroke
          </button>
          <button
